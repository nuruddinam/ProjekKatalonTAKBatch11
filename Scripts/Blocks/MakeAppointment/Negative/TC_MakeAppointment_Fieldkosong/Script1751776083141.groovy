...
//Script untuk Failed Appointment
String message = WebUI.getAttribute(findTestObject('Page_MakeAppointment/inputVisitDate_text'), "validationMessage")
println(message)

WebUI.verifyEqual(message, "Please fill out this field.")
